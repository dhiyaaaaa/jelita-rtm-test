...
@section('content')
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form method="POST" action="{{ route('jenjang.store') }}" id="create-form">
            @csrf
            <div class="card-body">
                {{-- Jenjang Input --}}
                <div class="form-group">
                    ...
                    <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"
                        id="nama" placeholder="Masukkan Nama Jenjang">
                    @if ($errors->has('nama'))
                ...
                <div>
                    ...
                    <x-button-submit text="Tambah Jenjang" formId="create-form" />
                </div>
            </div>
        </form>
