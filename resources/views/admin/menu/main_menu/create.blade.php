...
@section('content')
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form method="POST" action="{{ route('main_menu.store') }}" id="create-form">
            @csrf
            <div class="card-body">
                {{-- Menu Input --}}
                <div class="form-group">
                    ...
                    <input type="text" name="mainmenu" class="form-control @error('mainmenu') is-invalid @enderror"
                        id="mainmenu" placeholder="Masukkan Main Menu">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror"
                        id="deskripsi" placeholder="Masukkan Deskripsi Main Menu">
                ...
                <div class="form-group">
                    ...
                    @endforeach
                    <small class="form-text text-muted">Kelompokkan menu yang sesuai.</small>
                    @if ($errors->has('menus'))
                ...
                <div>
                    ...
                    <x-button-submit text="Tambah Main Menu" formId="create-form" />
                </div>
            </div>
        </form>
