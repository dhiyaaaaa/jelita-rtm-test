...
@section('content')
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form method="POST" action="{{ route('submenu.store', $menu->id) }}" id="create-form">
            @csrf
            <div class="card-body">
                {{-- Menu Input --}}
                <div class="form-group">
                    ...
                    <input type="text" name="submenu" class="form-control @error('submenu') is-invalid @enderror"
                        id="submenu" placeholder="Masukkan Submenu">
                ...
                <div>
                    ...
                    <x-button-submit text="Tambah Submenu" formId="create-form" />
                </div>
            </div>
        </form>
