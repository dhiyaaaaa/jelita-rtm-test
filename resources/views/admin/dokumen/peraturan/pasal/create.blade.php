...
@section('content')
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form method="POST" action="{{ route('pasal.store') }}" id="create-form">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="pasal" class="form-control @error('pasal') is-invalid @enderror"
                        id="pasal" placeholder="Masukkan Pasal">
                    @if ($errors->has('pasal'))
                ...
                <div class="form-group">
                    ...
                    <span class="text-danger">&#42;</span>
                    <textarea name="isi" cols="30" rows="10" class="form-control @error('isi') is-invalid @enderror" id="isi"
                ...
                <div>
                    ...
                    <x-button-submit text="Tambah Pasal" formId="create-form" />
                </div>
            </div>
        </form>
