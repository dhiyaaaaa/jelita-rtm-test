...
@section('content')
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form method="POST" action="{{ route('peraturan.update', $peraturan->id) }}" id="create-form">
            @csrf
            @method('put')
            <div class="card-body">
                {{-- peraturan Input --}}
                <div class="form-group">
                    ...
                    <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"
                        id="nama" placeholder="Masukkan Peraturan" value="{{ $peraturan->nama }}">
                    @if ($errors->has('nama'))
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="tahun" class="form-control @error('tahun') is-invalid @enderror"
                        id="tahun" placeholder="Masukkan Tahun" value="{{ $peraturan->tahun }}">
                    @if ($errors->has('tahun'))
                ...
                <div class="form-group">
                    ...
                    <div class="d-flex">
                        <div class="custom-control custom-radio mr-5">
                            <input class="custom-control-input" type="radio" id="aktif" name="status" value="1" {{ $peraturan->status == 1 ? 'checked' : '' }}>
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" type="radio" id="tidak_aktif" name="status"
                                value="0" {{ $peraturan->status == 0 ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <x-button-submit text="Edit Peraturan" formId="create-form" />
                </div>
            </div>
        </form>
