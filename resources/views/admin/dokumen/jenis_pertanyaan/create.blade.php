...
@section('content')
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form method="POST" action="{{ route('jenis_pertanyaan.store') }}" id="create-form">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"
                        id="nama" placeholder="Masukkan Jenis Pertanyaan">
                    @if ($errors->has('nama'))
                ...
                <div>
                    ...
                    <x-button-submit text="Tambah Jenis Pertanyaan" formId="create-form" />
                </div>
            </div>
        </form>
