...
@section('content')
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form method="POST" action="{{ route('auditor.tindak-lanjut.update', ['monitoring' => $monitoring->id]) }}"
            id="create-form">
            @csrf
            @method('PUT')
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="tgl" class="form-control @error('tgl') is-invalid @enderror"
                        id="tgl" placeholder="Masukkan Level" value="{{ $monitoring->tgl }}">
                    @if ($errors->has('tgl'))
                ...
                <!-- /.form-group -->
                <div>
                    <a href="{{ route('auditor.lapangan.show', $monitoring->jadwal_audit_id) }}" class="btn btn-outline-secondary">Kembali</a>
