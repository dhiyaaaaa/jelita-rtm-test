            ...
            <div class="tab-content" id="notificationTabsContent">
                                        ...
                                        <div>
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <h3 class="timeline-header">
                                                    <a href="#">{{ $item->auditee->user->name }}</a> mengirim notifikasi
                                                    pada <span class="text-bold">{{ $item->jadwal_audit->jadwal }}</span>
                                                </h3>
                                                <div class="timeline-body">
                                                    <span class="text-bold">
                                                        {{ $item->prodi->nama ?? ($item->fakultas->nama ?? $item->unit->nama) }}
                                                    </span>
                ...
                @hasanyrole('pj_universitas|pj_fakultas|pj_prodi|gkm')
                    <div class="tab-pane fade {{ $hasAuditeeRole && !$hasAuditorRole ? 'show active' : '' }}" id="auditee"
                                    ...
                                    @foreach ($items as $item)
                                        ...
                                        <div>
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <h3 class="timeline-header">
                                                    <a href="#">{{ $item->auditor->user->name }}</a> mengirim notifikasi
                                                    pada <span class="text-bold">{{ $item->jadwal_audit->jadwal }}</span>
                                                </h3>
                                                <div class="timeline-body">
                                                    <p>{{ $item->pesan }}</p>
                        ...
                        @else
                            <p>Belum ada notifikasi sebagai Auditee</p>
                        @endif
                    </div>
                @endhasanyrole
            </div>
