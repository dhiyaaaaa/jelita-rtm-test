...
<div class="livewire-rtm-index-wrapper">
    {{-- Kartu Utama --}}
                    ...
                    @forelse ($rtmJadwal as $index => $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <button wire:click="openLampiranModal('{{ $item->id }}')" class="btn btn-outline-primary btn-sm btn-fixed-size">+Lampiran</button>
                            </td>
                            <td class="text-center">
                            ...
                            <td class="text-center">
                                <div class="dropdown">
                                    <button class="btn btn-outline-primary btn-sm dropdown-toggle btn-fixed-size"
                                        type="button" id="dropdownMenuButton_{{ $item->id }}"
    ...
    <div x-data="{ show: @entangle('showLampiranModal') }" x-show="show" x-cloak
        :class="{'show d-block': show}" class="modal fade" tabindex="-1" role="dialog"
        aria-hidden="true" x-on:click.outside="show = false; $wire.closeLampiranModal()">
                ...
                <form wire:submit.prevent="saveLampiran">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Upload file PDF maks. 2MB</small>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Upload file PDF maks. 5MB</small>
    ...
    <script>
        document.addEventListener('livewire:initialized', () => {
            ...
            Livewire.hook('element.init', ({ el }) => {
                if (el.id === 'rtm' && $.fn.DataTable.isDataTable('#rtm')) {
