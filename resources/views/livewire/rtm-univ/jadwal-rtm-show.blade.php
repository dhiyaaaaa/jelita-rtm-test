            ...
            @if($isEditMode)
                <form wire:submit.prevent="updateJadwalRtm" dusk="edit-form">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary me-2" dusk="update-button">Simpan Perubahan</button>
            ...
            @else
                ...
                <div class="card mt-3" dusk="show-card">
                    ...
                    <div class="card-footer text-center">
                        ...
                        <button wire:click="toggleEditMode" dusk="edit-button" class="btn btn-warning">Edit Jadwal</button>
                    </div>
                </div>
            @endif
        </div>
