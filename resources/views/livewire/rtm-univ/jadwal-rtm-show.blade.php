<div class="container">
    <div class="card">
        ...
        @if($isEditMode)
            <form wire:submit.prevent="updateJadwalRtm" dusk="edit-form">
                <div class="row mb-3">
                    <div class="col-md-6">
                ...
                <div class="mb-3"> 
                    ...
                    <select name="jadwal_audit_id" id="jadwal_audit_id" wire:model="jadwal_audit_id"
                        dusk="jadwal_audit-input" class="form-control @error('jadwal_audit_id') is-invalid @enderror bg-white text-black">
                ...
                <div class="d-flex justify-content-end">
                    <button type="submit" class="btn btn-primary me-2" dusk="update-button">Simpan</button>
                    <button type="button" wire:click="toggleEditMode" class="btn btn-secondary" dusk="cancel-edit-button">Batal</button>
                </div>
            </form>
        @else
            <div class="card mt-3" dusk="show-card">
                ...
                <div class="card-body">
                    ...
                    <div class="card-footer text-center">
                        ...
                        <button type="button" wire:click="toggleEditMode" class="btn btn-warning" dusk="edit-button">Edit Jadwal</button>
                    </div>
                </div>
            @endif
        </div>
