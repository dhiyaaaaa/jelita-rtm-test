...
<body>
    @foreach ($temuanAudit as $key => $data)
    <div class="container">
        <h4>Daftar Rencana Tindak Lanjut Hasil Audit {{ $data['nama'] }}</h4>
        <table class="table">
            <thead>
                <tr>
                    <th>No</th>
                ...
                @foreach ($data['temuan'] as $item)
                    <tr>
                        ...
                        <td class="tindak-lanjut">
                            <ol>
                                @if ($jawabanTindakLanjut->isNotEmpty())
                                    ...
                                    @endforeach
                                @else
                                    <p class="text-muted">Tidak ada tindak lanjut</p>
                                @endif
                            </ol>
                        </td>
                    </tr>
