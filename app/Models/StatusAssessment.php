...
class StatusAssessment extends Model
{
    use HasFactory;

    protected $table = 'status_assessment';

    protected $fillable = ['jadwal_audit_id', 'prodi_id', 'fakultas_id', 'unit_id', 'auditor_penilai_id', 'auditor_dinilai_id', 'status'];
