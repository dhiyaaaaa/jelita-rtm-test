...
return new class extends Migration
{
    ...
    {
        Schema::create('monitoring_form_status', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('status', ['selesai', 'proses', 'belum_dilaksanakan'])->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('monitoring_form_status');
    }
};
